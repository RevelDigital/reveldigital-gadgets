...
module.exports = __webpack_require__(/*! C:\Users\mike_\Documents\GitHub\ng-calendar-app\src\main.ts */"zUnb");
...
/* harmony import */ var _iconify_icons_fluent_clock_24_regular__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @iconify-icons/fluent/clock-24-regular */ "mWxj");
/* harmony import */ var _iconify_icons_fluent_location_28_regular__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @iconify-icons/fluent/location-28-regular */ "dakY");
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ "z/o8");
/* harmony import */ var gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! gsap/ScrollToPlugin */ "lCAa");
...
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../safe.pipe */ "Z2+D");
...
const _c1 = ["eventsEl"];
const _c2 = ["itemEl"];
function BannerComponent_div_4_ic_icon_21_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelement"](0, "ic-icon", 14);
} }
const _c3 = function (a0, a1) { return { odd: a0, even: a1 }; };
...
function BannerComponent_div_4_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function BannerComponent_div_4_Template_div_click_3_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r10); const ctx_r9 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r9.scroll(); });
...
class BannerComponent {
    constructor(iconService, domSanitizer) {
...
BannerComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: BannerComponent, selectors: [["app-banner"]], viewQuery: function BannerComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { events: "events", width: "width", height: "height" }, decls: 5, vars: 5, consts: [[1, "container"], ["containerEl", ""], ["fxLayout", "column", "fxLayoutAlign", "center center", 1, "events"], ["eventsEl", ""], ["style", "width:100%;", 4, "ngFor", "ngForOf"], [2, "width", "100%"], ["fxFlex", "", "fxLayout", "row", "fxLayoutAlign", "center center", 1, "item", 3, "ngClass", "ngStyle"], ["itemEl", ""], ["fxFlex", "20", 1, "date", 3, "click"], ["fxFlex", "", 1, "details"], [3, "innerHtml"], ["icon", "clock"], [2, "margin-left", "3em"], ["icon", "location", 4, "ngIf"], ["icon", "location"]], template: function BannerComponent_Template(rf, ctx) { if (rf & 1) {
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](BannerComponent, [{
    ...
    }], function () { return [{ type: _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_5__["IconService"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_6__["DomSanitizer"] }]; }, { containerEl: [{
...
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! gsap */ "z/o8");
/* harmony import */ var _layouts_banner_banner_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./layouts/banner/banner.component */ "LgWK");
/* harmony import */ var _layouts_table_table_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./layouts/table/table.component */ "iNfI");
/* harmony import */ var gsap_ScrollToPlugin__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! gsap/ScrollToPlugin */ "lCAa");
/* harmony import */ var _iconify_icons_fluent_location_28_regular__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @iconify-icons/fluent/location-28-regular */ "dakY");
/* harmony import */ var _iconify_icons_fluent_clock_24_regular__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @iconify-icons/fluent/clock-24-regular */ "mWxj");
...
/* harmony import */ var _ical_service__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ical.service */ "x2Ol");
...
function AppComponent_app_banner_0_Template(rf, ctx) { if (rf & 1) {
...
function AppComponent_app_table_1_Template(rf, ctx) { if (rf & 1) {
...
class AppComponent {
    constructor(http, domSanitizer, iconService, icalService) {
        this.http = http;
        this.domSanitizer = domSanitizer;
        this.iconService = iconService;
    ...
    ngOnInit() {
        this.sub = this.startPolling(this.pollingInterval).subscribe((res) => {
            this.events = res;
        });
        if (this.scrolling) {
            setInterval(() => {
    ...
    startPolling(interval = 30000) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_1__["timer"])(0, interval)
            .pipe(
        //switchMap(() => this.icalService.getEvents('https://calendar.google.com/calendar/ical/4t0mtlq6irm5dl32gp9euutajg%40group.calendar.google.com/public/basic.ics')
        ...
        Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["switchMap"])(() => this.icalService.getEvents(this.calUrl)));
    }
    requestData(url) {
        return this.http
            .get(url);
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], viewQuery: function AppComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, hostVars: 4, hostBindings: function AppComponent_HostBindings(rf, ctx) { if (rf & 2) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵstyleProp"]("width", ctx.width, "px")("height", ctx.height, "px");
    } }, decls: 2, vars: 2, consts: [[3, "width", "height", "events", 4, "ngIf"], [3, "width", "height", "events"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [_angular_common__WEBPACK_IMPORTED_MODULE_13__["NgIf"], _layouts_banner_banner_component__WEBPACK_IMPORTED_MODULE_4__["BannerComponent"], _layouts_table_table_component__WEBPACK_IMPORTED_MODULE_5__["TableComponent"]], styles: ["\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAuY29tcG9uZW50LnNjc3MifQ== */"] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppComponent, [{
    ...
    }], function () { return [{ type: _angular_common_http__WEBPACK_IMPORTED_MODULE_9__["HttpClient"] }, { type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_10__["DomSanitizer"] }, { type: _visurel_iconify_angular__WEBPACK_IMPORTED_MODULE_11__["IconService"] }, { type: _ical_service__WEBPACK_IMPORTED_MODULE_12__["ICalService"] }]; }, { banner: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](SafePipe, [{
...
/* harmony import */ var _reveldigital_player_client__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @reveldigital/player-client */ "GQtI");
...
/* harmony import */ var _angular_common_locales_fr__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @angular/common/locales/fr */ "Hfs6");
...
/* harmony import */ var _angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @angular/common/locales/ru */ "wq8c");
/* harmony import */ var _angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_ru__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _angular_common_locales_es__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @angular/common/locales/es */ "2Yyj");
...
/* harmony import */ var _angular_common_locales_de__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @angular/common/locales/de */ "VLs4");
/* harmony import */ var _angular_common_locales_de__WEBPACK_IMPORTED_MODULE_13___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_de__WEBPACK_IMPORTED_MODULE_13__);
/* harmony import */ var _angular_common_locales_nl__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/common/locales/nl */ "b6vB");
/* harmony import */ var _angular_common_locales_nl__WEBPACK_IMPORTED_MODULE_14___default = /*#__PURE__*/__webpack_require__.n(_angular_common_locales_nl__WEBPACK_IMPORTED_MODULE_14__);
/* harmony import */ var _layouts_banner_banner_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./layouts/banner/banner.component */ "LgWK");
/* harmony import */ var _layouts_table_table_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./layouts/table/table.component */ "iNfI");
/* harmony import */ var _safe_pipe__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./safe.pipe */ "Z2+D");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_9__["AppComponent"],
        _layouts_banner_banner_component__WEBPACK_IMPORTED_MODULE_15__["BannerComponent"],
        _layouts_table_table_component__WEBPACK_IMPORTED_MODULE_16__["TableComponent"],
        _safe_pipe__WEBPACK_IMPORTED_MODULE_17__["SafePipe"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
        _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"],
        _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClientModule"],
        _angular_material_table__WEBPACK_IMPORTED_MODULE_6__["MatTableModule"],
        _angular_flex_layout__WEBPACK_IMPORTED_MODULE_5__["FlexLayoutModule"],
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _layouts_banner_banner_component__WEBPACK_IMPORTED_MODULE_15__["BannerComponent"],
                    _layouts_table_table_component__WEBPACK_IMPORTED_MODULE_16__["TableComponent"],
                    _safe_pipe__WEBPACK_IMPORTED_MODULE_17__["SafePipe"]
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_0__["BrowserModule"],
                    _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_1__["BrowserAnimationsModule"],
...
function TableComponent_td_6_span_1_Template(rf, ctx) { if (rf & 1) {
...
function TableComponent_td_6_span_2_Template(rf, ctx) { if (rf & 1) {
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵtext"](1);
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵpipe"](2, "date");
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
...
function TableComponent_tr_14_Template(rf, ctx) { if (rf & 1) {
    ...
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function TableComponent_tr_14_Template_tr_click_0_listener() { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r24); const ctx_r23 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"](); return ctx_r23.scroll(); });
    _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
} if (rf & 2) {
    const i_r19 = ctx.index;
    const odd_r21 = ctx.odd;
...
TableComponent.ɵfac = function TableComponent_Factory(t) { return new (t || TableComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"])); };
TableComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: TableComponent, selectors: [["app-table"]], viewQuery: function TableComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, inputs: { events: "events", width: "width", height: "height" }, decls: 15, vars: 7, consts: [[1, "container"], ["containerEl", ""], ["mat-table", "", 3, "dataSource"], ["table", ""], ["matColumnDef", "when"], ["mat-header-cell", "", 4, "matHeaderCellDef"], ["mat-cell", "", 4, "matCellDef"], ["matColumnDef", "where"], ["matColumnDef", "summary"], ["id", "header", "mat-header-row", "", 3, "ngStyle", "hidden", 4, "matHeaderRowDef"], ["mat-row", "", 3, "ngStyle", "click", 4, "matRowDef", "matRowDefColumns"], ["mat-header-cell", ""], ["mat-cell", ""], [4, "ngIf"], [1, "time"], ["id", "header", "mat-header-row", "", 3, "ngStyle", "hidden"], ["header", ""], ["mat-row", "", 3, "ngStyle", "click"], ["row", ""]], template: function TableComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0, 1);
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](TableComponent, [{
    ...
    }], function () { return [{ type: _angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["DomSanitizer"] }]; }, { containerEl: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['containerEl']
        }], table: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['table', { read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] }]
        }], header: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"],
            args: ['header', { read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"] }]
        }], rows: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChildren"],
            args: ["row", { read: _angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewContainerRef"] }]
        }], events: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
        }], width: [{
            type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"]
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ICalService", function() { return ICalService; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
class ICalService {
    ...
    getEvents(calendarUrl) {
        ...
        const now = moment_timezone__WEBPACK_IMPORTED_MODULE_1__().format('YYYY-MM-DDThh:mm');
        const endDateRange = (d) => {
            if (d === '365') {
        ...
        const url = `https://glacial-hollows-70580.herokuapp.com/ical/${now}/${endDateRange(this.futureEvents)}?url=${encodeURIComponent(calendarUrl)}`;
        return this.http.get(url).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(data => this.mapEvents(data)));
    }
    mapEvents(data) {
        let events = [];
        if (data.occurrences) {
            events = events.concat(data.occurrences.map(o => ({
                startDate: o.startDate.isDate ?
                    moment_timezone__WEBPACK_IMPORTED_MODULE_1__([o.startDate.year, o.startDate.month - 1, o.startDate.day], o.startDate.timezone === 'floating' ? null : o.startDate.timezone) :
                    moment_timezone__WEBPACK_IMPORTED_MODULE_1__["tz"]([o.startDate.year, o.startDate.month - 1, o.startDate.day, o.startDate.hour, o.startDate.minute], o.startDate.timezone === 'floating' ? null : o.startDate.timezone),
                endDate: o.endDate.isDate ?
                    moment_timezone__WEBPACK_IMPORTED_MODULE_1__["tz"]([o.endDate.year, o.endDate.month - 1, o.endDate.day], o.endDate.timezone === 'floating' ? null : o.endDate.timezone) :
                    moment_timezone__WEBPACK_IMPORTED_MODULE_1__["tz"]([o.endDate.year, o.endDate.month - 1, o.endDate.day, o.endDate.hour, o.endDate.minute], o.endDate.timezone === 'floating' ? null : o.endDate.timezone),
                allDay: o.startDate.isDate,
                location: this.getProperty(o.item, 'location'),
                summary: this.getProperty(o.item, 'summary'),
                description: this.getProperty(o.item, 'description')
            })));
        }
        if (data.events) {
            events = events.concat(data.events.map(o => ({
                startDate: moment_timezone__WEBPACK_IMPORTED_MODULE_1__(this.getProperty(o, 'dtstart')),
                endDate: moment_timezone__WEBPACK_IMPORTED_MODULE_1__(this.getProperty(o, 'dtend')),
                location: this.getProperty(o, 'location'),
                summary: this.getProperty(o, 'summary'),
                description: this.getProperty(o, 'description'),
                allDay: this.DATEONLY_REGEX.test(this.getProperty(o, 'dtstart'))
            })));
        }
    ...
    getProperty(item, propName) {
        if (item && item.component[0] === 'vevent') {
            return item.component[1].find(o => o[0] === propName) ? item.component[1].find(o => o[0] === propName)[3] : null;
        }
        return '';
    }
}
ICalService.ɵfac = function ICalService_Factory(t) { return new (t || ICalService)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_3__["HttpClient"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵinject"](_reveldigital_player_client__WEBPACK_IMPORTED_MODULE_4__["PlayerClientService"])); };
ICalService.ɵprov = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjectable"]({ token: ICalService, factory: ICalService.ɵfac, providedIn: 'root' });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](ICalService, [{
