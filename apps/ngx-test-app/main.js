...
class PlayerClientService {
  ...
  constructor(zone) {
    ...
    typeof messageEvent.data === 'string'), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_7__.map)(e => JSON.parse(e.data)), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_5__.share)(), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(e => {
      console.log(e);
      if (e.type === 'applyConfig' && e.isOpener) {
        //this.applyConfig(e); // propagate config to iframe parent from the popup window
        e.isOpener = false;
        window.parent.postMessage(JSON.stringify(e), '*');
      } else if (e.type === 'openConfig') {
        this.onConfig$.next(null);
      }
    }), (0,rxjs_operators__WEBPACK_IMPORTED_MODULE_6__.tap)(e => this.onPostMessage$.next(e)));
    let self = this;
    window.RevelDigital = {
      Controller: {
...
class NoopClient {
  ...
  applyConfig(prefs) {
    // let evt = new CustomEvent<IConfig>('RevelDigital.Config', { detail: { type: ConfigType.ApplyConfig, prefs: prefs, isOpener: window.opener !== null } });
    // if (window.opener) {
