...
return number+output},week:{dow:1,doy:4}});var months$3='leden_únor_brezen_duben_kveten_cerven_cervenec_srpen_zárí_ríjen_listopad_prosinec'.split('_'),monthsShort='led_úno_bre_dub_kve_cvn_cvc_srp_zár_ríj_lis_pro'.split('_');var monthsParse=[/^led/i,/^úno/i,/^bre/i,/^dub/i,/^kve/i,/^(cvn|cerven$|cervna)/i,/^(cvc|cervenec|cervence)/i,/^srp/i,/^zár/i,/^ríj/i,/^lis/i,/^pro/i];var monthsRegex$1=/^(leden|únor|brezen|duben|kveten|cervenec|cervence|cerven|cervna|srpen|zárí|ríjen|listopad|prosinec|led|úno|bre|dub|kve|cvn|cvc|srp|zár|ríj|lis|pro)/i;function plural$1(n){return(n>1)&&(n<5)&&(~~(n/10)!==1)}
...
break;case 'M':return(withoutSuffix||isFuture)?'mesíc':'mesícem';case 'MM':if(withoutSuffix||isFuture){return result+(plural$1(number)?'mesíce':'mesícu')}else{return result+'mesíci'}
...
break}}
hooks.defineLocale('cs',{months:months$3,monthsShort:monthsShort,monthsRegex:monthsRegex$1,monthsShortRegex:monthsRegex$1,monthsStrictRegex:/^(leden|ledna|února|únor|brezen|brezna|duben|dubna|kveten|kvetna|cervenec|cervence|cerven|cervna|srpen|srpna|zárí|ríjen|ríjna|listopadu|listopad|prosinec|prosince)/i,monthsShortStrictRegex:/^(led|úno|bre|dub|kve|cvn|cvc|srp|zár|ríj|lis|pro)/i,monthsParse:monthsParse,longMonthsParse:monthsParse,shortMonthsParse:monthsParse,weekdays:'nedele_pondelí_úterý_streda_ctvrtek_pátek_sobota'.split('_'),weekdaysShort:'ne_po_út_st_ct_pá_so'.split('_'),weekdaysMin:'ne_po_út_st_ct_pá_so'.split('_'),longDateFormat:{LT:'H:mm',LTS:'H:mm:ss',L:'DD.MM.YYYY',LL:'D. MMMM YYYY',LLL:'D. MMMM YYYY H:mm',LLLL:'dddd D. MMMM YYYY H:mm',l:'D. M. YYYY'},calendar:{sameDay:'[dnes v] LT',nextDay:'[zítra v] LT',nextWeek:function(){switch(this.day()){case 0:return'[v nedeli v] LT';case 1:case 2:return'[v] dddd [v] LT';case 3:return'[ve stredu v] LT';case 4:return'[ve ctvrtek v] LT';case 5:return'[v pátek v] LT';case 6:return'[v sobotu v] LT'}},lastDay:'[vcera v] LT',lastWeek:function(){switch(this.day()){case 0:return'[minulou nedeli v] LT';case 1:case 2:return'[minulé] dddd [v] LT';case 3:return'[minulou stredu v] LT';case 4:case 5:return'[minulý] dddd [v] LT';case 6:return'[minulou sobotu v] LT'}},sameElse:'L'},relativeTime:{future:'za %s',past:'pred %s',s:translate$1,ss:translate$1,m:translate$1,mm:translate$1,h:translate$1,hh:translate$1,d:translate$1,dd:translate$1,M:translate$1,MM:translate$1,y:translate$1,yy:translate$1},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:'%d.',week:{dow:1,doy:4}});hooks.defineLocale('cv',{months:'??????_?????_???_???_???_??????_???_?????_????_???_???_??????'.split('_'),monthsShort:'???_???_???_???_???_???_???_???_???_???_???_???'.split('_'),weekdays:'???????????_????????_?????????_?????_???????????_???????_????????'.split('_'),weekdaysShort:'???_???_???_??_???_???_???'.split('_'),weekdaysMin:'??_??_??_??_??_??_??'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD-MM-YYYY',LL:'YYYY [?????] MMMM [??????] D[-????]',LLL:'YYYY [?????] MMMM [??????] D[-????], HH:mm',LLLL:'dddd, YYYY [?????] MMMM [??????] D[-????], HH:mm'},calendar:{sameDay:'[????] LT [???????]',nextDay:'[????] LT [???????]',lastDay:'[????] LT [???????]',nextWeek:'[?????] dddd LT [???????]',lastWeek:'[?????] dddd LT [???????]',sameElse:'L'},relativeTime:{future:function(output){var affix=/?????$/i.exec(output)?'???':/???$/i.exec(output)?'???':'???';return output+affix},past:'%s ??????',s:'???-?? ???????',ss:'%d ???????',m:'??? ?????',mm:'%d ?????',h:'??? ?????',hh:'%d ?????',d:'??? ???',dd:'%d ???',M:'??? ????',MM:'%d ????',y:'??? ???',yy:'%d ???'},dayOfMonthOrdinalParse:/\d{1,2}-???/,ordinal:'%d-???',week:{dow:1,doy:7}});hooks.defineLocale('cy',{months:'Ionawr_Chwefror_Mawrth_Ebrill_Mai_Mehefin_Gorffennaf_Awst_Medi_Hydref_Tachwedd_Rhagfyr'.split('_'),monthsShort:'Ion_Chwe_Maw_Ebr_Mai_Meh_Gor_Aws_Med_Hyd_Tach_Rhag'.split('_'),weekdays:'Dydd Sul_Dydd Llun_Dydd Mawrth_Dydd Mercher_Dydd Iau_Dydd Gwener_Dydd Sadwrn'.split('_'),weekdaysShort:'Sul_Llun_Maw_Mer_Iau_Gwe_Sad'.split('_'),weekdaysMin:'Su_Ll_Ma_Me_Ia_Gw_Sa'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'dddd, D MMMM YYYY HH:mm'},calendar:{sameDay:'[Heddiw am] LT',nextDay:'[Yfory am] LT',nextWeek:'dddd [am] LT',lastDay:'[Ddoe am] LT',lastWeek:'dddd [diwethaf am] LT',sameElse:'L'},relativeTime:{future:'mewn %s',past:'%s yn ôl',s:'ychydig eiliadau',ss:'%d eiliad',m:'munud',mm:'%d munud',h:'awr',hh:'%d awr',d:'diwrnod',dd:'%d diwrnod',M:'mis',MM:'%d mis',y:'blwyddyn',yy:'%d flynedd'},dayOfMonthOrdinalParse:/\d{1,2}(fed|ain|af|il|ydd|ed|eg)/,ordinal:function(number){var b=number,output='',lookup=['','af','il','ydd','ydd','ed','ed','ed','fed','fed','fed','eg','fed','eg','eg','fed','eg','eg','fed','eg','fed'];if(b>20){if(b===40||b===50||b===60||b===80||b===100){output='fed'}else{output='ain'}}else if(b>0){output=lookup[b]}
...
if(meridiem==='rati'){return hour<4?hour:hour+12}else if(meridiem==='sokalli'){return hour}else if(meridiem==='donparam'){return hour>12?hour:hour+12}else if(meridiem==='sanje'){return hour+12}},meridiem:function(hour,minute,isLower){if(hour<4){return'rati'}else if(hour<12){return'sokalli'}else if(hour<16){return'donparam'}else if(hour<20){return'sanje'}else{return'rati'}}});var symbolMap$6={'1':'?','2':'?','3':'?','4':'?','5':'?','6':'?','7':'?','8':'?','9':'?','0':'?'},numberMap$5={'?':'1','?':'2','?':'3','?':'4','?':'5','?':'6','?':'7','?':'8','?':'9','?':'0'};hooks.defineLocale('gu',{months:'?????????_?????????_?????_??????_??_???_?????_?????_?????????_???????_???????_????????'.split('_'),monthsShort:'??????._??????._?????_?????._??_???_????._??._?????._?????._???._????.'.split('_'),monthsParseExact:!0,weekdays:'??????_??????_???????_???????_???????_????????_??????'.split('_'),weekdaysShort:'???_???_????_????_????_?????_???'.split('_'),weekdaysMin:'?_??_??_??_??_??_?'.split('_'),longDateFormat:{LT:'A h:mm ??????',LTS:'A h:mm:ss ??????',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY, A h:mm ??????',LLLL:'dddd, D MMMM YYYY, A h:mm ??????'},calendar:{sameDay:'[??] LT',nextDay:'[????] LT',nextWeek:'dddd, LT',lastDay:'[??????] LT',lastWeek:'[?????] dddd, LT',sameElse:'L'},relativeTime:{future:'%s ??',past:'%s ?????',s:'???? ???',ss:'%d ?????',m:'?? ?????',mm:'%d ?????',h:'?? ????',hh:'%d ????',d:'?? ????',dd:'%d ????',M:'?? ?????',MM:'%d ?????',y:'?? ????',yy:'%d ????'},preparse:function(string){return string.replace(/[??????????]/g,function(match){return numberMap$5[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$6[match]})},meridiemParse:/???|????|????|????/,meridiemHour:function(hour,meridiem){if(hour===12){hour=0}
if(meridiem==='???'){return hour<4?hour:hour+12}else if(meridiem==='????'){return hour}else if(meridiem==='????'){return hour>=10?hour:hour+12}else if(meridiem==='????'){return hour+12}},meridiem:function(hour,minute,isLower){if(hour<4){return'???'}else if(hour<10){return'????'}else if(hour<17){return'????'}else if(hour<20){return'????'}else{return'???'}},week:{dow:0,doy:6}});hooks.defineLocale('he',{months:'?????_??????_???_?????_???_????_????_??????_??????_???????_??????_?????'.split('_'),monthsShort:'????_????_???_????_???_????_????_????_????_????_????_????'.split('_'),weekdays:'?????_???_?????_?????_?????_????_???'.split('_'),weekdaysShort:'??_??_??_??_??_??_??'.split('_'),weekdaysMin:'?_?_?_?_?_?_?'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D [?]MMMM YYYY',LLL:'D [?]MMMM YYYY HH:mm',LLLL:'dddd, D [?]MMMM YYYY HH:mm',l:'D/M/YYYY',ll:'D MMM YYYY',lll:'D MMM YYYY HH:mm',llll:'ddd, D MMM YYYY HH:mm'},calendar:{sameDay:'[???? ??]LT',nextDay:'[??? ??]LT',nextWeek:'dddd [????] LT',lastDay:'[????? ??]LT',lastWeek:'[????] dddd [?????? ????] LT',sameElse:'L'},relativeTime:{future:'???? %s',past:'???? %s',s:'???? ?????',ss:'%d ?????',m:'???',mm:'%d ????',h:'???',hh:function(number){if(number===2){return'??????'}
return number+' ????'},d:'???',dd:function(number){if(number===2){return'??????'}
return number+' ????'},M:'????',MM:function(number){if(number===2){return'???????'}
return number+' ??????'},y:'???',yy:function(number){if(number===2){return'??????'}else if(number%10===0&&number!==10){return number+' ???'}
return number+' ????'}},meridiemParse:/???"?|????"?|???? ???????|???? ???????|????? ????|?????|????/i,isPM:function(input){return/^(???"?|???? ???????|????)$/.test(input)},meridiem:function(hour,minute,isLower){if(hour<5){return'????? ????'}else if(hour<10){return'?????'}else if(hour<12){return isLower?'????"?':'???? ???????'}else if(hour<18){return isLower?'???"?':'???? ???????'}else{return'????'}}});var symbolMap$7={'1':'?','2':'?','3':'?','4':'?','5':'?','6':'?','7':'?','8':'?','9':'?','0':'?'},numberMap$6={'?':'1','?':'2','?':'3','?':'4','?':'5','?':'6','?':'7','?':'8','?':'9','?':'0'};hooks.defineLocale('hi',{months:'?????_??????_?????_??????_??_???_?????_?????_???????_???????_??????_???????'.split('_'),monthsShort:'??._???._?????_?????._??_???_???._??._???._?????._??._???.'.split('_'),monthsParseExact:!0,weekdays:'??????_??????_???????_??????_???????_????????_??????'.split('_'),weekdaysShort:'???_???_????_???_????_?????_???'.split('_'),weekdaysMin:'?_??_??_??_??_??_?'.split('_'),longDateFormat:{LT:'A h:mm ???',LTS:'A h:mm:ss ???',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY, A h:mm ???',LLLL:'dddd, D MMMM YYYY, A h:mm ???'},calendar:{sameDay:'[??] LT',nextDay:'[??] LT',nextWeek:'dddd, LT',lastDay:'[??] LT',lastWeek:'[?????] dddd, LT',sameElse:'L'},relativeTime:{future:'%s ???',past:'%s ????',s:'??? ?? ????',ss:'%d ?????',m:'?? ????',mm:'%d ????',h:'?? ????',hh:'%d ????',d:'?? ???',dd:'%d ???',M:'?? ?????',MM:'%d ?????',y:'?? ????',yy:'%d ????'},preparse:function(string){return string.replace(/[??????????]/g,function(match){return numberMap$6[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$7[match]})},meridiemParse:/???|????|?????|???/,meridiemHour:function(hour,meridiem){if(hour===12){hour=0}
...
hooks.defineLocale('lb',{months:'Januar_Februar_Mäerz_Abrëll_Mee_Juni_Juli_August_September_Oktober_November_Dezember'.split('_'),monthsShort:'Jan._Febr._Mrz._Abr._Mee_Jun._Jul._Aug._Sept._Okt._Nov._Dez.'.split('_'),monthsParseExact:!0,weekdays:'Sonndeg_Méindeg_Dënschdeg_Mëttwoch_Donneschdeg_Freideg_Samschdeg'.split('_'),weekdaysShort:'So._Mé._Dë._Më._Do._Fr._Sa.'.split('_'),weekdaysMin:'So_Mé_Dë_Më_Do_Fr_Sa'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'H:mm [Auer]',LTS:'H:mm:ss [Auer]',L:'DD.MM.YYYY',LL:'D. MMMM YYYY',LLL:'D. MMMM YYYY H:mm [Auer]',LLLL:'dddd, D. MMMM YYYY H:mm [Auer]'},calendar:{sameDay:'[Haut um] LT',sameElse:'L',nextDay:'[Muer um] LT',nextWeek:'dddd [um] LT',lastDay:'[Gëschter um] LT',lastWeek:function(){switch(this.day()){case 2:case 4:return'[Leschten] dddd [um] LT';default:return'[Leschte] dddd [um] LT'}}},relativeTime:{future:processFutureTime,past:processPastTime,s:'e puer Sekonnen',ss:'%d Sekonnen',m:processRelativeTime$5,mm:'%d Minutten',h:processRelativeTime$5,hh:'%d Stonnen',d:processRelativeTime$5,dd:'%d Deeg',M:processRelativeTime$5,MM:'%d Méint',y:processRelativeTime$5,yy:'%d Joer'},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:'%d.',week:{dow:1,doy:4}});hooks.defineLocale('lo',{months:'??????_?????_????_????_???????_??????_???????_?????_?????_????_?????_?????'.split('_'),monthsShort:'??????_?????_????_????_???????_??????_???????_?????_?????_????_?????_?????'.split('_'),weekdays:'?????_???_??????_???_?????_???_????'.split('_'),weekdaysShort:'???_???_??????_???_?????_???_????'.split('_'),weekdaysMin:'?_?_??_?_??_??_?'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'???dddd D MMMM YYYY HH:mm'},meridiemParse:/????????|??????/,isPM:function(input){return input==='??????'},meridiem:function(hour,minute,isLower){if(hour<12){return'????????'}else{return'??????'}},calendar:{sameDay:'[??????????] LT',nextDay:'[???????????] LT',nextWeek:'[???]dddd[???????] LT',lastDay:'[?????????????] LT',lastWeek:'[???]dddd[???????????] LT',sameElse:'L'},relativeTime:{future:'??? %s',past:'%s??????',s:'????????????????',ss:'%d ??????',m:'1 ????',mm:'%d ????',h:'1 ???????',hh:'%d ???????',d:'1 ???',dd:'%d ???',M:'1 ?????',MM:'%d ?????',y:'1 ??',yy:'%d ??'},dayOfMonthOrdinalParse:/(???)\d{1,2}/,ordinal:function(number){return'???'+number}});var units={'ss':'sekunde_sekundžiu_sekundes','m':'minute_minutes_minute','mm':'minutes_minuciu_minutes','h':'valanda_valandos_valanda','hh':'valandos_valandu_valandas','d':'diena_dienos_diena','dd':'dienos_dienu_dienas','M':'menuo_menesio_menesi','MM':'menesiai_menesiu_menesius','y':'metai_metu_metus','yy':'metai_metu_metus'};function translateSeconds(number,withoutSuffix,key,isFuture){if(withoutSuffix){return'kelios sekundes'}else{return isFuture?'keliu sekundžiu':'kelias sekundes'}}
function translateSingular(number,withoutSuffix,key,isFuture){return withoutSuffix?forms(key)[0]:(isFuture?forms(key)[1]:forms(key)[2])}
function special(number){return number%10===0||(number>10&&number<20)}
function forms(key){return units[key].split('_')}
function translate$6(number,withoutSuffix,key,isFuture){var result=number+' ';if(number===1){return result+translateSingular(number,withoutSuffix,key[0],isFuture)}else if(withoutSuffix){return result+(special(number)?forms(key)[1]:forms(key)[0])}else{if(isFuture){return result+forms(key)[1]}else{return result+(special(number)?forms(key)[1]:forms(key)[2])}}}
hooks.defineLocale('lt',{months:{format:'sausio_vasario_kovo_balandžio_gegužes_birželio_liepos_rugpjucio_rugsejo_spalio_lapkricio_gruodžio'.split('_'),standalone:'sausis_vasaris_kovas_balandis_geguže_birželis_liepa_rugpjutis_rugsejis_spalis_lapkritis_gruodis'.split('_'),isFormat:/D[oD]?(\[[^\[\]]*\]|\s)+MMMM?|MMMM?(\[[^\[\]]*\]|\s)+D[oD]?/},monthsShort:'sau_vas_kov_bal_geg_bir_lie_rgp_rgs_spa_lap_grd'.split('_'),weekdays:{format:'sekmadieni_pirmadieni_antradieni_treciadieni_ketvirtadieni_penktadieni_šeštadieni'.split('_'),standalone:'sekmadienis_pirmadienis_antradienis_treciadienis_ketvirtadienis_penktadienis_šeštadienis'.split('_'),isFormat:/dddd HH:mm/},weekdaysShort:'Sek_Pir_Ant_Tre_Ket_Pen_Šeš'.split('_'),weekdaysMin:'S_P_A_T_K_Pn_Š'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'YYYY-MM-DD',LL:'YYYY [m.] MMMM D [d.]',LLL:'YYYY [m.] MMMM D [d.], HH:mm [val.]',LLLL:'YYYY [m.] MMMM D [d.], dddd, HH:mm [val.]',l:'YYYY-MM-DD',ll:'YYYY [m.] MMMM D [d.]',lll:'YYYY [m.] MMMM D [d.], HH:mm [val.]',llll:'YYYY [m.] MMMM D [d.], ddd, HH:mm [val.]'},calendar:{sameDay:'[Šiandien] LT',nextDay:'[Rytoj] LT',nextWeek:'dddd LT',lastDay:'[Vakar] LT',lastWeek:'[Praejusi] dddd LT',sameElse:'L'},relativeTime:{future:'po %s',past:'prieš %s',s:translateSeconds,ss:translate$6,m:translateSingular,mm:translate$6,h:translateSingular,hh:translate$6,d:translateSingular,dd:translate$6,M:translateSingular,MM:translate$6,y:translateSingular,yy:translate$6},dayOfMonthOrdinalParse:/\d{1,2}-oji/,ordinal:function(number){return number+'-oji'},week:{dow:1,doy:4}});var units$1={'ss':'sekundes_sekundem_sekunde_sekundes'.split('_'),'m':'minutes_minutem_minute_minutes'.split('_'),'mm':'minutes_minutem_minute_minutes'.split('_'),'h':'stundas_stundam_stunda_stundas'.split('_'),'hh':'stundas_stundam_stunda_stundas'.split('_'),'d':'dienas_dienam_diena_dienas'.split('_'),'dd':'dienas_dienam_diena_dienas'.split('_'),'M':'meneša_menešiem_menesis_meneši'.split('_'),'MM':'meneša_menešiem_menesis_meneši'.split('_'),'y':'gada_gadiem_gads_gadi'.split('_'),'yy':'gada_gadiem_gads_gadi'.split('_')};function format$1(forms,number,withoutSuffix){if(withoutSuffix){return number%10===1&&number%100!==11?forms[2]:forms[3]}else{return number%10===1&&number%100!==11?forms[0]:forms[1]}}
...
function relativeSeconds(number,withoutSuffix){return withoutSuffix?'dažas sekundes':'dažam sekundem'}
hooks.defineLocale('lv',{months:'janvaris_februaris_marts_aprilis_maijs_junijs_julijs_augusts_septembris_oktobris_novembris_decembris'.split('_'),monthsShort:'jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_dec'.split('_'),weekdays:'svetdiena_pirmdiena_otrdiena_trešdiena_ceturtdiena_piektdiena_sestdiena'.split('_'),weekdaysShort:'Sv_P_O_T_C_Pk_S'.split('_'),weekdaysMin:'Sv_P_O_T_C_Pk_S'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD.MM.YYYY.',LL:'YYYY. [gada] D. MMMM',LLL:'YYYY. [gada] D. MMMM, HH:mm',LLLL:'YYYY. [gada] D. MMMM, dddd, HH:mm'},calendar:{sameDay:'[Šodien pulksten] LT',nextDay:'[Rit pulksten] LT',nextWeek:'dddd [pulksten] LT',lastDay:'[Vakar pulksten] LT',lastWeek:'[Pagajuša] dddd [pulksten] LT',sameElse:'L'},relativeTime:{future:'pec %s',past:'pirms %s',s:relativeSeconds,ss:relativeTimeWithPlural$1,m:relativeTimeWithSingular,mm:relativeTimeWithPlural$1,h:relativeTimeWithSingular,hh:relativeTimeWithPlural$1,d:relativeTimeWithSingular,dd:relativeTimeWithPlural$1,M:relativeTimeWithSingular,MM:relativeTimeWithPlural$1,y:relativeTimeWithSingular,yy:relativeTimeWithPlural$1},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:'%d.',week:{dow:1,doy:4}});var translator={words:{ss:['sekund','sekunda','sekundi'],m:['jedan minut','jednog minuta'],mm:['minut','minuta','minuta'],h:['jedan sat','jednog sata'],hh:['sat','sata','sati'],dd:['dan','dana','dana'],MM:['mjesec','mjeseca','mjeseci'],yy:['godina','godine','godina']},correctGrammaticalCase:function(number,wordKey){return number===1?wordKey[0]:(number>=2&&number<=4?wordKey[1]:wordKey[2])},translate:function(number,withoutSuffix,key){var wordKey=translator.words[key];if(key.length===1){return withoutSuffix?wordKey[0]:wordKey[1]}else{return number+' '+translator.correctGrammaticalCase(number,wordKey)}}};hooks.defineLocale('me',{months:'januar_februar_mart_april_maj_jun_jul_avgust_septembar_oktobar_novembar_decembar'.split('_'),monthsShort:'jan._feb._mar._apr._maj_jun_jul_avg._sep._okt._nov._dec.'.split('_'),monthsParseExact:!0,weekdays:'nedjelja_ponedjeljak_utorak_srijeda_cetvrtak_petak_subota'.split('_'),weekdaysShort:'ned._pon._uto._sri._cet._pet._sub.'.split('_'),weekdaysMin:'ne_po_ut_sr_ce_pe_su'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'H:mm',LTS:'H:mm:ss',L:'DD.MM.YYYY',LL:'D. MMMM YYYY',LLL:'D. MMMM YYYY H:mm',LLLL:'dddd, D. MMMM YYYY H:mm'},calendar:{sameDay:'[danas u] LT',nextDay:'[sjutra u] LT',nextWeek:function(){switch(this.day()){case 0:return'[u] [nedjelju] [u] LT';case 3:return'[u] [srijedu] [u] LT';case 6:return'[u] [subotu] [u] LT';case 1:case 2:case 4:case 5:return'[u] dddd [u] LT'}},lastDay:'[juce u] LT',lastWeek:function(){var lastWeekDays=['[prošle] [nedjelje] [u] LT','[prošlog] [ponedjeljka] [u] LT','[prošlog] [utorka] [u] LT','[prošle] [srijede] [u] LT','[prošlog] [cetvrtka] [u] LT','[prošlog] [petka] [u] LT','[prošle] [subote] [u] LT'];return lastWeekDays[this.day()]},sameElse:'L'},relativeTime:{future:'za %s',past:'prije %s',s:'nekoliko sekundi',ss:translator.translate,m:translator.translate,mm:translator.translate,h:translator.translate,hh:translator.translate,d:'dan',dd:translator.translate,M:'mjesec',MM:translator.translate,y:'godinu',yy:translator.translate},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:'%d.',week:{dow:1,doy:7}});hooks.defineLocale('mi',{months:'Kohi-tate_Hui-tanguru_Poutu-te-rangi_Paenga-whawha_Haratua_Pipiri_Hongoingoi_Here-turi-koka_Mahuru_Whiringa-a-nuku_Whiringa-a-rangi_Hakihea'.split('_'),monthsShort:'Kohi_Hui_Pou_Pae_Hara_Pipi_Hongoi_Here_Mahu_Whi-nu_Whi-ra_Haki'.split('_'),monthsRegex:/(?:['a-z\u0101\u014D\u016B]+\-?){1,3}/i,monthsStrictRegex:/(?:['a-z\u0101\u014D\u016B]+\-?){1,3}/i,monthsShortRegex:/(?:['a-z\u0101\u014D\u016B]+\-?){1,3}/i,monthsShortStrictRegex:/(?:['a-z\u0101\u014D\u016B]+\-?){1,2}/i,weekdays:'Ratapu_Mane_Turei_Wenerei_Taite_Paraire_Hatarei'.split('_'),weekdaysShort:'Ta_Ma_Tu_We_Tai_Pa_Ha'.split('_'),weekdaysMin:'Ta_Ma_Tu_We_Tai_Pa_Ha'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY [i] HH:mm',LLLL:'dddd, D MMMM YYYY [i] HH:mm'},calendar:{sameDay:'[i teie mahana, i] LT',nextDay:'[apopo i] LT',nextWeek:'dddd [i] LT',lastDay:'[inanahi i] LT',lastWeek:'dddd [whakamutunga i] LT',sameElse:'L'},relativeTime:{future:'i roto i %s',past:'%s i mua',s:'te hekona ruarua',ss:'%d hekona',m:'he meneti',mm:'%d meneti',h:'te haora',hh:'%d haora',d:'he ra',dd:'%d ra',M:'he marama',MM:'%d marama',y:'he tau',yy:'%d tau'},dayOfMonthOrdinalParse:/\d{1,2}º/,ordinal:'%dº',week:{dow:1,doy:4}});hooks.defineLocale('mk',{months:'???????_????????_????_?????_???_????_????_??????_?????????_????????_???????_????????'.split('_'),monthsShort:'???_???_???_???_???_???_???_???_???_???_???_???'.split('_'),weekdays:'??????_??????????_???????_?????_????????_?????_??????'.split('_'),weekdaysShort:'???_???_???_???_???_???_???'.split('_'),weekdaysMin:'?e_?o_??_??_??_??_?a'.split('_'),longDateFormat:{LT:'H:mm',LTS:'H:mm:ss',L:'D.MM.YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY H:mm',LLLL:'dddd, D MMMM YYYY H:mm'},calendar:{sameDay:'[????? ??] LT',nextDay:'[???? ??] LT',nextWeek:'[??] dddd [??] LT',lastDay:'[????? ??] LT',lastWeek:function(){switch(this.day()){case 0:case 3:case 6:return'[??????????] dddd [??] LT';case 1:case 2:case 4:case 5:return'[??????????] dddd [??] LT'}},sameElse:'L'},relativeTime:{future:'????? %s',past:'???? %s',s:'??????? ???????',ss:'%d ???????',m:'??????',mm:'%d ??????',h:'???',hh:'%d ????',d:'???',dd:'%d ????',M:'?????',MM:'%d ??????',y:'??????',yy:'%d ??????'},dayOfMonthOrdinalParse:/\d{1,2}-(??|??|??|??|??|??)/,ordinal:function(number){var lastDigit=number%10,last2Digits=number%100;if(number===0){return number+'-??'}else if(last2Digits===0){return number+'-??'}else if(last2Digits>10&&last2Digits<20){return number+'-??'}else if(lastDigit===1){return number+'-??'}else if(lastDigit===2){return number+'-??'}else if(lastDigit===7||lastDigit===8){return number+'-??'}else{return number+'-??'}},week:{dow:1,doy:7}});hooks.defineLocale('ml',{months:'??????_?????????_???????_??????_????_???_????_????????_??????????_???????_?????_??????'.split('_'),monthsShort:'???._??????._???._?????._????_???_????._??._???????._?????._???._????.'.split('_'),monthsParseExact:!0,weekdays:'????????_??????????_?????????_????????_?????????_???????????_????????'.split('_'),weekdaysShort:'????_??????_?????_????_??????_??????_???'.split('_'),weekdaysMin:'??_??_??_??_????_??_?'.split('_'),longDateFormat:{LT:'A h:mm -??',LTS:'A h:mm:ss -??',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY, A h:mm -??',LLLL:'dddd, D MMMM YYYY, A h:mm -??'},calendar:{sameDay:'[?????] LT',nextDay:'[????] LT',nextWeek:'dddd, LT',lastDay:'[??????] LT',lastWeek:'[??????] dddd, LT',sameElse:'L'},relativeTime:{future:'%s ???????',past:'%s ?????',s:'??? ?????????',ss:'%d ????????',m:'??? ????????',mm:'%d ????????',h:'??? ????????',hh:'%d ????????',d:'??? ?????',dd:'%d ?????',M:'??? ????',MM:'%d ????',y:'??? ????',yy:'%d ????'},meridiemParse:/??????|??????|???? ???????|??????????|??????/i,meridiemHour:function(hour,meridiem){if(hour===12){hour=0}
if((meridiem==='??????'&&hour>=4)||meridiem==='???? ???????'||meridiem==='??????????'){return hour+12}else{return hour}},meridiem:function(hour,minute,isLower){if(hour<4){return'??????'}else if(hour<12){return'??????'}else if(hour<17){return'???? ???????'}else if(hour<20){return'??????????'}else{return'??????'}}});function translate$7(number,withoutSuffix,key,isFuture){switch(key){case 's':return withoutSuffix?'?????? ??????':'?????? ????????';case 'ss':return number+(withoutSuffix?' ??????':' ????????');case 'm':case 'mm':return number+(withoutSuffix?' ?????':' ???????');case 'h':case 'hh':return number+(withoutSuffix?' ???':' ??????');case 'd':case 'dd':return number+(withoutSuffix?' ????':' ??????');case 'M':case 'MM':return number+(withoutSuffix?' ???':' ?????');case 'y':case 'yy':return number+(withoutSuffix?' ???':' ??????');default:return number}}
hooks.defineLocale('mn',{months:'????????? ???_?????????? ???_??????????? ???_??????????? ???_????????? ???_??????????? ???_????????? ???_?????????? ???_???????? ???_?????????? ???_????? ????????? ???_????? ?????????? ???'.split('_'),monthsShort:'1 ???_2 ???_3 ???_4 ???_5 ???_6 ???_7 ???_8 ???_9 ???_10 ???_11 ???_12 ???'.split('_'),monthsParseExact:!0,weekdays:'???_?????_??????_??????_?????_??????_?????'.split('_'),weekdaysShort:'???_???_???_???_???_???_???'.split('_'),weekdaysMin:'??_??_??_??_??_??_??'.split('_'),weekdaysParseExact:!0,longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'YYYY-MM-DD',LL:'YYYY ??? MMMM?? D',LLL:'YYYY ??? MMMM?? D HH:mm',LLLL:'dddd, YYYY ??? MMMM?? D HH:mm'},meridiemParse:/??|??/i,isPM:function(input){return input==='??'},meridiem:function(hour,minute,isLower){if(hour<12){return'??'}else{return'??'}},calendar:{sameDay:'[???????] LT',nextDay:'[???????] LT',nextWeek:'[????] dddd LT',lastDay:'[???????] LT',lastWeek:'[????????] dddd LT',sameElse:'L'},relativeTime:{future:'%s ?????',past:'%s ????',s:translate$7,ss:translate$7,m:translate$7,mm:translate$7,h:translate$7,hh:translate$7,d:translate$7,dd:translate$7,M:translate$7,MM:translate$7,y:translate$7,yy:translate$7},dayOfMonthOrdinalParse:/\d{1,2} ????/,ordinal:function(number,period){switch(period){case 'd':case 'D':case 'DDD':return number+' ????';default:return number}}});var symbolMap$b={'1':'?','2':'?','3':'?','4':'?','5':'?','6':'?','7':'?','8':'?','9':'?','0':'?'},numberMap$a={'?':'1','?':'2','?':'3','?':'4','?':'5','?':'6','?':'7','?':'8','?':'9','?':'0'};function relativeTimeMr(number,withoutSuffix,string,isFuture)
{var output='';if(withoutSuffix){switch(string){case 's':output='???? ?????';break;case 'ss':output='%d ?????';break;case 'm':output='?? ?????';break;case 'mm':output='%d ??????';break;case 'h':output='?? ???';break;case 'hh':output='%d ???';break;case 'd':output='?? ????';break;case 'dd':output='%d ????';break;case 'M':output='?? ?????';break;case 'MM':output='%d ?????';break;case 'y':output='?? ????';break;case 'yy':output='%d ?????';break}}
else{switch(string){case 's':output='???? ???????';break;case 'ss':output='%d ???????';break;case 'm':output='??? ??????';break;case 'mm':output='%d ???????';break;case 'h':output='??? ????';break;case 'hh':output='%d ?????';break;case 'd':output='??? ?????';break;case 'dd':output='%d ??????';break;case 'M':output='??? ???????';break;case 'MM':output='%d ????????';break;case 'y':output='??? ?????';break;case 'yy':output='%d ??????';break}}
return output.replace(/%d/i,number)}
hooks.defineLocale('mr',{months:'????????_??????????_?????_??????_??_???_????_?????_????????_???????_?????????_???????'.split('_'),monthsShort:'????._??????._?????._?????._??._???._????._??._??????._?????._???????._?????.'.split('_'),monthsParseExact:!0,weekdays:'??????_??????_???????_??????_???????_????????_??????'.split('_'),weekdaysShort:'???_???_????_???_????_?????_???'.split('_'),weekdaysMin:'?_??_??_??_??_??_?'.split('_'),longDateFormat:{LT:'A h:mm ?????',LTS:'A h:mm:ss ?????',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY, A h:mm ?????',LLLL:'dddd, D MMMM YYYY, A h:mm ?????'},calendar:{sameDay:'[??] LT',nextDay:'[?????] LT',nextWeek:'dddd, LT',lastDay:'[???] LT',lastWeek:'[?????] dddd, LT',sameElse:'L'},relativeTime:{future:'%s?????',past:'%s??????',s:relativeTimeMr,ss:relativeTimeMr,m:relativeTimeMr,mm:relativeTimeMr,h:relativeTimeMr,hh:relativeTimeMr,d:relativeTimeMr,dd:relativeTimeMr,M:relativeTimeMr,MM:relativeTimeMr,y:relativeTimeMr,yy:relativeTimeMr},preparse:function(string){return string.replace(/[??????????]/g,function(match){return numberMap$a[match]})},postformat:function(string){return string.replace(/\d/g,function(match){return symbolMap$b[match]})},meridiemParse:/??????|?????|??????|????????/,meridiemHour:function(hour,meridiem){if(hour===12){hour=0}
...
break;case 'd':return(withoutSuffix||isFuture)?'den':'dnom';case 'dd':if(withoutSuffix||isFuture){return result+(plural$5(number)?'dni':'dní')}else{return result+'dnami'}
...
hooks.defineLocale('tlh',{months:'tera’ jar wa’_tera’ jar cha’_tera’ jar wej_tera’ jar loS_tera’ jar vagh_tera’ jar jav_tera’ jar Soch_tera’ jar chorgh_tera’ jar Hut_tera’ jar wa’maH_tera’ jar wa’maH wa’_tera’ jar wa’maH cha’'.split('_'),monthsShort:'jar wa’_jar cha’_jar wej_jar loS_jar vagh_jar jav_jar Soch_jar chorgh_jar Hut_jar wa’maH_jar wa’maH wa’_jar wa’maH cha’'.split('_'),monthsParseExact:!0,weekdays:'lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj'.split('_'),weekdaysShort:'lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj'.split('_'),weekdaysMin:'lojmItjaj_DaSjaj_povjaj_ghItlhjaj_loghjaj_buqjaj_ghInjaj'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD.MM.YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'dddd, D MMMM YYYY HH:mm'},calendar:{sameDay:'[DaHjaj] LT',nextDay:'[wa’leS] LT',nextWeek:'LLL',lastDay:'[wa’Hu’] LT',lastWeek:'LLL',sameElse:'L'},relativeTime:{future:translateFuture,past:translatePast,s:'puS lup',ss:translate$a,m:'wa’ tup',mm:translate$a,h:'wa’ rep',hh:translate$a,d:'wa’ jaj',dd:translate$a,M:'wa’ jar',MM:translate$a,y:'wa’ DIS',yy:translate$a},dayOfMonthOrdinalParse:/\d{1,2}\./,ordinal:'%d.',week:{dow:1,doy:4}});var suffixes$4={1:'\'inci',5:'\'inci',8:'\'inci',70:'\'inci',80:'\'inci',2:'\'nci',7:'\'nci',20:'\'nci',50:'\'nci',3:'\'üncü',4:'\'üncü',100:'\'üncü',6:'\'nci',9:'\'uncu',10:'\'uncu',30:'\'uncu',60:'\'inci',90:'\'inci'};hooks.defineLocale('tr',{months:'Ocak_Subat_Mart_Nisan_Mayis_Haziran_Temmuz_Agustos_Eylül_Ekim_Kasim_Aralik'.split('_'),monthsShort:'Oca_Sub_Mar_Nis_May_Haz_Tem_Agu_Eyl_Eki_Kas_Ara'.split('_'),weekdays:'Pazar_Pazartesi_Sali_Çarsamba_Persembe_Cuma_Cumartesi'.split('_'),weekdaysShort:'Paz_Pts_Sal_Çar_Per_Cum_Cts'.split('_'),weekdaysMin:'Pz_Pt_Sa_Ça_Pe_Cu_Ct'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD.MM.YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'dddd, D MMMM YYYY HH:mm'},calendar:{sameDay:'[bugün saat] LT',nextDay:'[yarin saat] LT',nextWeek:'[gelecek] dddd [saat] LT',lastDay:'[dün] LT',lastWeek:'[geçen] dddd [saat] LT',sameElse:'L'},relativeTime:{future:'%s sonra',past:'%s önce',s:'birkaç saniye',ss:'%d saniye',m:'bir dakika',mm:'%d dakika',h:'bir saat',hh:'%d saat',d:'bir gün',dd:'%d gün',M:'bir ay',MM:'%d ay',y:'bir yil',yy:'%d yil'},ordinal:function(number,period){switch(period){case 'd':case 'D':case 'Do':case 'DD':return number;default:if(number===0){return number+'\'inci'}
...
hooks.defineLocale('tzm-latn',{months:'innayr_br?ayr?_mar?s?_ibrir_mayyw_ywnyw_ywlywz_?wšt_šwtanbir_kt?wbr?_nwwanbir_dwjnbir'.split('_'),monthsShort:'innayr_br?ayr?_mar?s?_ibrir_mayyw_ywnyw_ywlywz_?wšt_šwtanbir_kt?wbr?_nwwanbir_dwjnbir'.split('_'),weekdays:'asamas_aynas_asinas_akras_akwas_asimwas_asi?yas'.split('_'),weekdaysShort:'asamas_aynas_asinas_akras_akwas_asimwas_asi?yas'.split('_'),weekdaysMin:'asamas_aynas_asinas_akras_akwas_asimwas_asi?yas'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'dddd D MMMM YYYY HH:mm'},calendar:{sameDay:'[asdkh g] LT',nextDay:'[aska g] LT',nextWeek:'dddd [g] LT',lastDay:'[assant g] LT',lastWeek:'dddd [g] LT',sameElse:'L'},relativeTime:{future:'dadkh s yan %s',past:'yan %s',s:'imik',ss:'%d imik',m:'minu?',mm:'%d minu?',h:'sa?a',hh:'%d tassa?in',d:'ass',dd:'%d ossan',M:'ayowr',MM:'%d iyyirn',y:'asgas',yy:'%d isgasn'},week:{dow:6,doy:12}});hooks.defineLocale('tzm',{months:'??????_?????_????_?????_?????_?????_??????_????_????????_?????_????????_???????'.split('_'),monthsShort:'??????_?????_????_?????_?????_?????_??????_????_????????_?????_????????_???????'.split('_'),weekdays:'??????_?????_??????_?????_?????_???????_???????'.split('_'),weekdaysShort:'??????_?????_??????_?????_?????_???????_???????'.split('_'),weekdaysMin:'??????_?????_??????_?????_?????_???????_???????'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'DD/MM/YYYY',LL:'D MMMM YYYY',LLL:'D MMMM YYYY HH:mm',LLLL:'dddd D MMMM YYYY HH:mm'},calendar:{sameDay:'[???? ?] LT',nextDay:'[???? ?] LT',nextWeek:'dddd [?] LT',lastDay:'[????? ?] LT',lastWeek:'dddd [?] LT',sameElse:'L'},relativeTime:{future:'???? ? ??? %s',past:'??? %s',s:'????',ss:'%d ????',m:'?????',mm:'%d ?????',h:'????',hh:'%d ????????',d:'???',dd:'%d o????',M:'??o??',MM:'%d ??????',y:'?????',yy:'%d ??????'},week:{dow:6,doy:12}});hooks.defineLocale('ug-cn',{months:'??????_??????_????_??????_???_?????_?????_???????_????????_????????_???????_???????'.split('_'),monthsShort:'??????_??????_????_??????_???_?????_?????_???????_????????_????????_???????_???????'.split('_'),weekdays:'????????_???????_????????_????????_????????_????_?????'.split('_'),weekdaysShort:'??_??_??_??_??_??_??'.split('_'),weekdaysMin:'??_??_??_??_??_??_??'.split('_'),longDateFormat:{LT:'HH:mm',LTS:'HH:mm:ss',L:'YYYY-MM-DD',LL:'YYYY-????M-??????D-????',LLL:'YYYY-????M-??????D-????? HH:mm',LLLL:'dddd? YYYY-????M-??????D-????? HH:mm'},meridiemParse:/????? ????|?????|?????? ?????|???|?????? ?????|???/,meridiemHour:function(hour,meridiem){if(hour===12){hour=0}
